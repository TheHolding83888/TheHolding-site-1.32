...
requireIncludes('Curve Gauge Flow', text.gauge, 'Determine PR live-probe requirement');
requireIncludes('Curve Gauge Flow', text.gauge, "live_probe_needed=true");
requireIncludes('Curve Gauge Flow', text.gauge, 'Use current gauge evidence for workflow-only PR');
...
console.log('VLCVX / VOTIUM EVIDENCE HANDOFF CANARY PASS', {
  ...
  workflowOnlyPrUsesMaterializedGaugeEvidence: true,
  productionLiveProbeRequired: true,

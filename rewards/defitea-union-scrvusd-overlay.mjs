...
const VERSION = '0.2-defitea-votium-union-scrvusd-member-proof';
...
async function main(){
  ...
  // Union allocation indices follow UnionZap.outputTokens. scrvUSD processing starts from crvUSD,
  // which the specialized distributor deposits into the scrvUSD ERC-4626 vault before Merkle distribution.

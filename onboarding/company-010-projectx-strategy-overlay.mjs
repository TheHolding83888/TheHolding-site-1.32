...
async function main(){
  ...
  state.rewards.observations.push({id:'projectx-usdc-claimable',route:ROUTE_ID,protocol:'Project X',chain:'HyperEVM',token:'USDC',tokenAddress:usdcAddress,claimable:usdcClaimable,usdValue:round(claimableUsdcUsd,6),priceUsd:round(usdcPx,8),status:'measured',source:'collect.staticCall across current economically active WHYPE-USDC NFTs',method:'read-only; no signature or transaction'});

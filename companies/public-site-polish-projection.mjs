...
for(const token of [passportRoutingMarker,"window.thSelectCapitalMode = selectMode","#passport-(\\d{3})","'008':'Monetra.eth'","history.pushState({thPassportRegistry:reg}"]){

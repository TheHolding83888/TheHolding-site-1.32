(function(){
 ...
 function syncNav(){document.querySelectorAll('.navlinks').forEach(nav=>{ensureNavLink(nav,'/realty/atlas/','Atlas','/realty/markets/');ensureNavLink(nav,'/realty/income/','Income','/realty/physical/');ensureNavLink(nav,'/realty/sources/','Sources','/realty/markets/');nav.querySelectorAll('a').forEach(a=>{const href=a.getAttribute('href');if(href==='/realty/atlas/'&&location.pathname.startsWith('/realty/atlas/'))a.classList.add('active');if(href==='/realty/income/'&&location.pathname.startsWith('/realty/income/'))a.classList.add('active');if(href==='/realty/sources/'&&location.pathname.startsWith('/realty/sources/'))a.classList.add('active')})})}
 ...
 function ensurePageCss(){if(!location.pathname.startsWith('/realty/compare/')||document.querySelector('link[href="/realty/assets/realty-compare.css"]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='/realty/assets/realty-compare.css';document.head.append(l)}
 ...
 function boot(){syncTheme();syncNav();ensurePageCss();ensureV2()}

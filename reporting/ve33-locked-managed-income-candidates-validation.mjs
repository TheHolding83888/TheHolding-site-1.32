...
assert.throws(()=>validateLockedManagedEvidence({...source,semantics:{...source.semantics,historicalBoundaryIdentityMustMatch:false}}),/semantics invalid/);
assert.throws(()=>validateLockedManagedEvidence({...source,semantics:{...source.semantics,unchangedLastEarnAcrossExactBoundariesProvesNoSettlement:false}}),/semantics invalid/);

#!/usr/bin/env node
/**
 * The Holding · Accounting Coverage Registry v0.9
 *
...
export const VERSION='0.9-gmx-factual-tracking-accounting-mechanism-coverage-registry';

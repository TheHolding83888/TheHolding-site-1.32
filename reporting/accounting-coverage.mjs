#!/usr/bin/env node
/**
 * The Holding · Accounting Coverage Registry v0.10
 *
...
export const VERSION='0.10-explicit-settlement-link-accounting-mechanism-coverage-registry';

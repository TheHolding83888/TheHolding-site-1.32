 ...
 * Exact locked-managed ve(3,3) embedded-income evidence is attributed as a
 * supplemental income channel of the matching veAERO / veVELO mechanism while
 * preserving its canonical income family and source evidence semantics.
 */
...
export const VERSION='0.11-multi-income-channel-accounting-mechanism-coverage-registry';
...
function supplementalEventFamilyMatches(e,cls){return cls?.family==='accrued-entitlement'&&e?.family==='embedded-income'&&e?.sourceFile==='reporting/ve33-locked-managed-accounting-evidence.json'&&e?.sourceEvidenceFamily==='embedded-compounded-income'&&e?.mechanismKind==='locked-managed-reward';}
function eventMatches(e,cls){return(e?.family===cls.family||supplementalEventFamilyMatches(e,cls))&&textMatches(eventText(e),cls.hints);}

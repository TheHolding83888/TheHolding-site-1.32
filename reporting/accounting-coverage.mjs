#!/usr/bin/env node
/**
 * The Holding · Accounting Coverage Registry v0.12
 *
...
export const VERSION='0.12-partial-observation-capability-accounting-mechanism-coverage-registry';

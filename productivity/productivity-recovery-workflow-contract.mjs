...
for(const token of [
  ...
  'node productivity/productivity-recovery-workflow-contract.mjs'
]) assert.ok(text.includes(token),`Productivity recovery contract missing: ${token}`);
...
console.log('Productivity recovery workflow contract PASS',{

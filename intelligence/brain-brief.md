...
Generated: 2026-08-14T05:59:18.812Z
Mode: delta
Status: watch
...
- Proposed next step: Assess SRI feasibility, self-hosting, removal, or tighter CSP for the exact script. Preserve analytics behavior until the safer replacement is verified.
- Action mode: proposal-only
- Evidence: security/security-intelligence.json/currentFindings

...
Generated: 2026-09-08T09:24:46.950Z
Mode: delta
Status: watch
...
### What changed
Current canonical inputs contain 7 material Observer change(s), 0 new security finding event(s), and 4 resolved security finding event(s). Canonical protocol-economic context is available across 2 cohorts (f(x) veFXN Locker; Curve veCRV Fee Distributor). f(x) remains measured context with unresolved causality; Curve exposes a proven APR mechanical identity while the upstream cause of fee-distribution changes remains unresolved.

...
assert.match(workflow, /onboarding\/company-010-public-admission\.mjs/, 'Cypher admission source trigger missing');
...
assert.doesNotMatch(workflow, /company-010-public-admission\.mjs\s+--write/, 'Cypher admission diagnostic regained direct canonical-page mutation');

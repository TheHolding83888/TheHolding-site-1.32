...
assert.match(workflow,/run: node reporting\/company-monthly-earned-income\.mjs/,'monthly earned-income accounting promotion missing');
...
console.log('Company Monthly Reports workflow definition paired proof PASS',{
  ...
  referenceScaffold:'reporting/company-monthly-reports.mjs',
  earnedIncomePromotion:'reporting/company-monthly-earned-income.mjs',

...
async function main(){
  ...
  const retainedHistoricalLogRpcEndpointClasses=unique([
    ...(prior.observation?.retainedHistoricalLogRpcEndpointClasses||[]),
    ...(prior.observation?.historicalLogRpcEndpointClassesUsed||[])
  ]);
  if(retainedHistoricalLogRpcEndpointClasses.length<1)fail('Prior Gauge Flow historical RPC provenance missing');

...
async function main(){
  ...
  console.log('ECONOMIC GRAPH canonical + lifecycle candidates PASS',{
    ...
    fraxCanonicalSnapshots:fraxLifecycle?.longitudinalEvidence?.canonicalSnapshotCount,
    fraxValidatedNativePeriods:fraxLifecycle?.longitudinalEvidence?.validatedNativePeriodCount,
    fraxRequiredNativePeriods:fraxLifecycle?.longitudinalEvidence?.requiredValidatedNativePeriodCount,
    fraxCurrentHistoryParity:frax?.longitudinalEvidence?.currentAprParityOk,
    fraxNativeDepthClass:frax?.longitudinalEvidence?.depthClass,

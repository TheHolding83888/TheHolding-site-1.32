...
await import('./frax-frxeth-v2-ether-router-amo-composition-canary.mjs');
await import('./frax-frxeth-v2-ether-router-flow-canary.mjs');
...
await import('./frax-frxeth-v2-lending-flow-current-state-canary.mjs');
